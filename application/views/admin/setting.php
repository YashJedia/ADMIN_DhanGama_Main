						...
						<div class="card container">
							...
							<form action="<?=base_url()?>update_setting" method="post">
								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
										<div class="form-group">
											<label for="user_address">PN</label>
											<input type="text" class="form-control" id="user_address" placeholder="Payment Name" name="pn" value="<?= $result->payment_key ?>">
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
										<div class="form-group">
											<label for="user_address">PA</label>
											<input type="text" class="form-control" id="user_address" placeholder="UPI Id" name="pa" value="<?= $result->payment_marchent_key ?>">
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
										<div class="form-group">
											<label for="user_address">MC</label>
											<input type="text" class="form-control" id="user_address" placeholder="Marchant Category Code" name="mc" value="<?= $result->payment_secret_key ?>">
										</div>
									</div>
								</div>
